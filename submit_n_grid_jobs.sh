...
# Ex: bash submit_n_grid_jobs.sh -i /exp/dune/app/users/colweber/ndfd-pairs/ndfd_depos/nd-sim-tools/produce_scripts/produce_edep-paramreco_larbath_transrots_tdr.sh -t /exp/dune/app/users/colweber/ndfd-pairs/ndfd_depos/nd-sim-tools/inputs/jobdata.tar.gz -n 150
